...
(function () {
  angular.module('alumni')
    .controller('alumniProfileController', alumniProfileController);

  alumniProfileController.$inject = ['$scope', 'alumniFactory', 'countryFactory', 'customsDataTables', '$routeParams', '$window', '$location', '$ngBootbox', 'toasterService', 'Upload', 'programsFactory'];

  function alumniProfileController($scope, alumniFactory, countryFactory, customsDataTables, $routeParams, $window, $location, $ngBootbox, toasterService, Upload, programsFactory) {
